...
from deepsearch.data import selector_examples_from_trajectory, split_by_group
...
def main() -> None:
    ...
    examples = [
        example
        for trajectory in read_jsonl(args.input)
        for example in selector_examples_from_trajectory(trajectory)
    ]
